/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 3bdeac69de7c5a73377b738a2efb95d5)
...
declare namespace Cloudflare {
	...
	interface Env {
		FIREBASE_PROJECT_ID: "my-history-v2";
	}
}
